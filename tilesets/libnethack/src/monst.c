 ...
 */
    ...
    MON("black pudding", S_PUDDING,
        ...
        A(ATTK(AT_BITE, AD_CORR, 3, 5), ATTK(AT_NONE, AD_CORR, 0, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("blood pudding", S_PUDDING,
        LVL(25, 30, 0, 6, 75, 0), (G_NOGEN | 1),
        A(ATTK(AT_BITE, AD_PHYS, 1, 1),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(300, 250, 0, MS_SILENT, MZ_LARGE),
        MR_COLD | MR_ELEC | MR_POISON | MR_ACID | MR_STONE | MR_DISINT,
        MR_COLD | MR_ELEC | MR_POISON | MR_ACID | MR_STONE | MR_DISINT, MRACE_NONE,
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD |
